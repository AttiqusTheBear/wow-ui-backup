...
local MAJOR, MINOR = "LibDropDownMenu", 2;
...
function lib.UIDropDownMenu_CreateFrames(level, index)
	while ( level > lib.UIDROPDOWNMENU_MAXLEVELS ) do
		...
		local newList = CreateFrame("Button", "LibDropDownMenu_List"..lib.UIDROPDOWNMENU_MAXLEVELS, nil, "LibDropDownMenuListTemplate");
		newList:Hide();
		...
		for i=lib.UIDROPDOWNMENU_MINBUTTONS+1, lib.UIDROPDOWNMENU_MAXBUTTONS do
			local newButton = CreateFrame("Button", "LibDropDownMenu_List"..lib.UIDROPDOWNMENU_MAXLEVELS.."Button"..i, newList, "LibDropDownMenuButtonTemplate");
			newButton:SetID(i);
		end
	end
	...
	while ( index > lib.UIDROPDOWNMENU_MAXBUTTONS ) do
		...
		for i=1, lib.UIDROPDOWNMENU_MAXLEVELS do
			local newButton = CreateFrame("Button", "LibDropDownMenu_List"..i.."Button"..lib.UIDROPDOWNMENU_MAXBUTTONS, _G["LibDropDownMenu_List"..i], "LibDropDownMenuButtonTemplate");
