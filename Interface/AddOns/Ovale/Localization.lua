...
L["Artifact traits"] = "Путь артифакта"
L["Aura lag"] = "Задержка ауры"
L["Auras (player)"] = "Ауры (игрок)"
L["Auras (target)"] = "Ауры (цель)"
L["Auras on the player"] = "Ауры на игроке"
L["Auras on the target"] = "Ауры на цели"
L["Blood"] = "Кровь"
L["buff"] = "Баффы"
...
L["Reset"] = "Сброс"
L["Reset the profiling statistics."] = "Сбросить статистику профиля"
